...
RISK_RULES = {
    'profitability': {
        'gross_margin': [
          ...
          # 'message': '毛利率適中（10% ~ 40%），代表成本控制或定價能力有待加強。'},
        ...
        'net_margin': [
            ...
            #{'condition': lambda v: v is not None and 0.03 <= v < 0.15, 'level': 'medium',
            # 'message': '淨利率適中（3% ~ 15%），獲利空間薄弱。'},
        ...
        'roe': [
           ...
           # {'condition': lambda v: v is not None and 0 <=v < 0.15, 'level': 'danger',
            # 'message': 'ROE 為負，股東投入的資金目前無法創造報酬。'},
            {'condition': lambda v: v is not None and v >= 0.15, 'level': 'positive',
    ...
    'solvency': {
        'current_ratio': [
            ...
            #{'condition': lambda v: v is not None and 1.5 <= v < 2.0, 'level': 'warning',
             #'message': '流動比率偏低（1.5 ~ 2.0），短期資金調度需留意。'},
        ...
        'debt_ratio': [
            ...
            {'condition': lambda v: v is not None and 0.40 < v <= 0.70, 'level': 'warning',
             'message': '負債比率 40%~70%，財務槓桿中等，需持續關注。'},
            {'condition': lambda v: v is not None and v <= 0.40, 'level': 'positive',
        ...
        'interest_coverage': [
            {'condition': lambda v: v is not None and v < 2, 'level': 'danger',
             ...
             #{'condition': lambda v: v is not None and 2 <= v < 5, 'level': 'danger',
             #'message': '利息保障倍數（2 ~ 5)，公司獲利可能不足以支付利息。'},
    ...
    'efficiency': {
        ...
        'cash_cycle': [
            ...
            #{'condition': lambda v: v is not None and 0 <= v < 120, 'level': 'medium',
             #'message': '現金循環天數（0 ~ 120) 天，短期資金壓力可能較高。'},
